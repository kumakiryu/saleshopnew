...
const PERKS = [
  ...
  { icon: '🏷️', title: 'VIP Badge', desc: 'Stand out with your [VIP] badge' },
];
          ...
          <div className="flex items-center gap-3">
            ...
            {(isVip || isReseller) && (
              <span className="px-2 py-0.5 rounded text-xs font-bold" style={{
                background: isVip ? 'rgba(255,180,0,0.15)' : 'rgba(0,230,118,0.15)',
                color: isVip ? GOLD : '#00E676',
                border: `1px solid ${isVip ? 'rgba(255,180,0,0.3)' : 'rgba(0,230,118,0.3)'}`,
              }}>
                {isVip ? '✦ VIP' : '◆ RESELLER'}
              </span>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl" style={{ background: 'rgba(255,180,0,0.15)', border: '1px solid rgba(255,180,0,0.3)' }}>
                💎
              </div>
              <div>
            ...
            <p className="text-sm leading-relaxed mb-8" style={{ color: '#7b88c0' }}>
              Join our VIP program and unlock exclusive pricing, priority support, and members-only deals.
            </p>
            ...
            <div className="mt-6 p-4 rounded-xl" style={{ background: 'rgba(255,180,0,0.05)', border: '1px solid rgba(255,180,0,0.15)' }}>
              ...
              <p className="text-xs" style={{ color: '#7b88c0' }}>
                Open a ticket on our Discord server and request a membership account. Our team will create your account and assign your tier — usually within 24 hours.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            {user ? (
                ...
                {isVip ? (
                  <>
                    ...
                    <button onClick={() => navigate('/stock')} className="w-full py-3 rounded-xl text-sm font-bold tracking-wider" style={{
                      background: 'linear-gradient(135deg, rgba(255,180,0,0.2) 0%, rgba(255,140,0,0.2) 100%)',
                      border: '1px solid rgba(255,180,0,0.4)', color: GOLD,
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs mb-4" style={{ color: '#7b88c0' }}>
                      {isReseller ? 'You have Reseller membership.' : 'Your account is active. Open a ticket on Discord to request VIP upgrade.'}
                    </p>
              ...
              <>
                <div className="p-6 rounded-2xl" style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.02) 100%)', border: '1px solid rgba(255,255,255,0.07)' }}>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <button type="submit" disabled={loading} style={{
                      background: loading ? 'rgba(255,180,0,0.05)' : 'linear-gradient(135deg, rgba(255,180,0,0.2) 0%, rgba(255,140,0,0.2) 100%)',
                      border: '1px solid rgba(255,180,0,0.4)', color: loading ? '#3a4570' : GOLD,
                  ...
                  <div className="mt-5 pt-4" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                    <p className="text-[11px] text-center" style={{ color: '#3a4570' }}>
                      ...
                      <a href="https://discord.gg/2n5UZj56Nk" target="_blank" rel="noopener noreferrer" style={{ color: GOLD, textDecoration: 'none' }}>
                ...
                {/* Switch to Reseller login — below the login container */}
